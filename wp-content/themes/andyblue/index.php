        	...
        	<div class="BGmiddle">
               <?php
                 ...
                 foreach( get_categories('hide_empty=0&parent='.get_theme_option('cat1')) as $cat ) :			 
                    ...
                    echo '<li >';
                ?><a class="category" href="<?php echo $category_link ?>"><img width="110px"  src="<?php echo get_home_url(); ?>/wp-content/uploads/2011/07/<?php echo $cat->slug ; ?>.jpg" alt="<?php echo $cat->slug; ?>" />
              	  </a>
